        ...
        <div class="col text-center">
            ...
            <div class="bank-accounts">
                ...
                <div class="col2">
                    ...
                    <td><?php echo e($bank_account->bank_name, false); ?></td>
                </div>

                <div class="col2">

                    <p style="font-weight: bold;color: #00ADEF;"> اسم الحساب</p>
                    <td><?php echo e($bank_account->account_name, false); ?></td>
                </div>
                <div class="col2">
                    <p style="font-weight: bold;color: #00ADEF;"> رقم الحساب</p>
                    <td><?php echo e($bank_account->account_no, false); ?></td>
                </div>
                <div class="col2">
                    <p style="font-weight: bold;color: #00ADEF;"> رقم الأيبان</p>
                    <td><?php echo e($bank_account->iban, false); ?></td>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
